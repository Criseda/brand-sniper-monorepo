...
#### Fixed
- A REST snapshot whose lowest ask had not changed was scored and paper traded again on every poll, because polls are further apart than the 300 s dedup window. It is now a duplicate until its price changes, every snapshot is still recorded, and the paper executor buys each listing (or REST item and price) once (#265).
