...
_MIGRATION_MESSAGE = (
    ...
    "LLM_MODEL (e.g. qwen/qwen3.8-27b), LLM_API_KEY (your previous Groq key), and optionally "
    "LLM_FALLBACK_MODELS (e.g. openai/gpt-oss-120b,openai/gpt-oss-20b,qwen/qwen3.6-27b). "
