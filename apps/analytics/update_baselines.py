...
from shared_utils.models import MarketItem, ItemMacroBaseline
...
async def sync_baselines_to_edge():
    ...
    async with async_engine.connect() as conn:
        stmt = select(MarketItem.market_hash_name, ItemMacroBaseline.support_floor_cents, ItemMacroBaseline.latest_price_cents).join(
            ItemMacroBaseline, MarketItem.id == ItemMacroBaseline.item_id
        )
